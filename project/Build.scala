...
object ApplicationBuild extends Build {
  ...
  val appDependencies = Seq(
    ...
    "org.reactivemongo" %% "play2-reactivemongo" % "0.9-SNAPSHOT" from "http://jay.w3.org/~bertails/jar/play2-reactivemongo_2.10-0.9-20130307.jar",
    "org.reactivemongo" %% "reactivemongo" % "0.9-SNAPSHOT" /*cross CrossVersion.full*/ excludeAll(ExclusionRule(organization = "io.netty"), ExclusionRule(organization = "play")),
